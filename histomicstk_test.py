#https://digitalslidearchive.github.io/HistomicsTK/examples/nuclei_segmentation.html

!pip install histomicstk --user --find-links https://girder.github.io/large_image_wheels
...
input_image_file = "CLAM_images_test/tiles/41998_06449.jpg"
...
## alternative colornorm standardization?
...
im_nmzd = htk.preprocessing.color_normalization.reinhard(im_input, target_mu=cnorm['mu'], target_sigma=cnorm['sigma'])
